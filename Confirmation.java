...
public class Confirmation extends javax.swing.JDialog {
     ...
     */
    public Confirmation(java.awt.Frame parent, boolean modal, String Mess) {
        super(parent, modal);
        text = Mess;
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(66, 66, 66)
                    .addComponent(Message, javax.swing.GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE)
                    .addGap(66, 66, 66)))
        );
        ...
        setBounds((screenSize.width-378)/2, (screenSize.height-241)/2, 378, 241);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Confirmation dialog = new Confirmation(new javax.swing.JFrame(), true, text);
